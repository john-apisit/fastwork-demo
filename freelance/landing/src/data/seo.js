const defaultDescription = 'รับทำเว็บไซต์ Company Website, Web Application, CRM/ERP, ระบบคลังสินค้า และ Mobile App ด้วย Vue, React, Node.js และ Flutter — ออกแบบและพัฒนาตามความต้องการ พร้อมส่งมอบ Source Code';
export const siteSeo = {
    ...
    siteUrl: '',
    ogImage: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=1200&h=630&fit=crop&q=80',
    services: [
        'Company Website',
        'Web Application',
        'CRM & ERP',
...
export function buildSeoHeadTags(siteUrl) {
